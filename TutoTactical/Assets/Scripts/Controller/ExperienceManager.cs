...
public static class ExperienceManager {
    ...
    public static void AwardExperience(int amount,Party party)
    {
        ...
        //Step1: determine the range in actor level stats
        ...
        //Step2: weight the amount to award per actor based on their level
        ...
        //Step3: hand out the weighted award
        for(int i = ranks.Count - 1; i > 0; --i)
        {
